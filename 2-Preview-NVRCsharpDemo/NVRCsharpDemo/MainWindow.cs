...
namespace NVRCsharpDemo
{
    ...
    public partial class MainWindow : Form
    {
        ...
        //    Thread.Sleep(15);
        //   test = CHCNetSDK.NET_DVR_PTZControl_Other(m_lUserID, iChannelNum[(int)iSelIndex], 21, 1);
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Thread.Sleep(15);
            test = CHCNetSDK.NET_DVR_PTZControl_Other(m_lUserID, iChannelNum[(int)iSelIndex], 22, 1);
        }
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
           ...
           // pictureBox1.Refresh();//pictureBox1.BorderStyle =;
            RealPlayWnd.BorderStyle = BorderStyle.None;
            //RealPlayWnd.Refresh();
            panel = 2;
        }
        ...
        {
            RealPlayWnd.BorderStyle = BorderStyle.Fixed3D;
           // RealPlayWnd.Refresh();
